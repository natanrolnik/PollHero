<script>
  ...
  async function resetQuestions() {
    await fetch('https://poll-hero-server.natanrolnik.me/reset', {method: 'POST'})
  }
  
  async function nextQuestion() {
    await fetch('https://poll-hero-server.natanrolnik.me/next', {method: 'POST'})
  }
...
<!-- <main> -->
  ...
  <br>
  <br>
  <button type="button" on:click={ () => resetQuestions() }>
      Reset
  </button>
